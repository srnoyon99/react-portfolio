...
export default function DownloadButtonDark() {
    ...
    <div>
      <div >
        ...
        <a
          ...
          className="relative inline-flex items-center h-14 lg:h-16 w-50 lg:w-56 rounded-[20px] overflow-hidden shadow-2xl"
          style={{
